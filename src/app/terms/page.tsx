...
export const metadata = buildMetadata({
  title: "Terms of Use",
  description: "Terms of use for Slovenia from Koper — the basis on which we provide our Slovenia cruise port editorial guides and information.",
  path,
  noindex: true,
});
...
export default function TermsPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Terms of Use", description: "Terms of use for Slovenia from Koper.", path })]} />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-3xl">
          ...
          <div className="prose-body">
            ...
            <p>{SITE.name} provides editorial planning information and guidance for cruise passengers calling at Koper, Slovenia. It is offered in good faith for general guidance and does not constitute professional travel advice.</p>
